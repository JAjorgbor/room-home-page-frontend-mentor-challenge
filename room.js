  ...
  if (screenSize.matches) {
    ...
    while (i < 3) {
      document.querySelectorAll(".slide")[
        i
      ].src = `./images/desktop-image-hero-${i + 1}.jpg`;
      i++;
    }

    document.getElementById("last-pic-clone").src =
      "./images/desktop-image-hero-3.jpg";
    document.getElementById("first-pic-clone").src =
    ...
    while (i < 3) {
      document.querySelectorAll(".slide")[
        i
      ].src = `./images/mobile-image-hero-${i + 1}.jpg`;
      i++;
    }
    document.getElementById("last-pic-clone").src =
